...
const trafficMovement = heatmapData?.traffic
const pageviewMovement = heatmapData?.pageviews
const pvsMovement = heatmapData?.pvs
const mofuMovement = heatmapData?.mofu
...
/* ----------------------------- */
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 text-slate-900">
      ...
      <main className="flex-1 px-6 py-10 lg:px-">
