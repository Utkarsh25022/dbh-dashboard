...
export function TrafficShareChart({ data, isLoading }: TrafficShareChartProps) {
  ...
  useEffect(() => {
    ...
    const searchShare = data.map((d) => Number(d.searchShare))
    const trafficShare = data.map((d) => Number(d.trafficShare))
    const pageViewsShare = data.map((d) => Number(d.pageViewsShare))
